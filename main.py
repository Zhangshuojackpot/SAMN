...
parser.add_argument('--use_glmc', default=0., type=float, help='weighted for Loss')
...
parser.add_argument('--root_log', type=str, default='SAMN-CVPR2026/output/')
...
def main():
    ...
    print(args)
    args.store_name = '#'.join(["dataset: " + args.dataset, "arch: " + args.arch,"imbanlance_rate: " + str(args.imbanlance_rate), 'use_glmc:' + str(args.use_glmc)])
